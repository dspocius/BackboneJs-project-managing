define(['./module'], function (services) {
    ...
    services.factory('collection', ['common','model',function (common, model) {
        return function(data){
			...
			collection.getFirstModelByProperty = function(property, value){
                var index, i;
                var model = '';
                for (index = 0; index < collection.models.length; ++index) {
                    if((collection.models[index][property] === value  || (value == false && typeof collection.models[index][property] == "undefined")) && model == ''){
                        model = collection.models[index];
                    }
                }
                return model;
            }
            collection.findByTwoProperties = function(property1, value1, property2, value2){
                var index, i;
                var model = '';
                for (index = 0; index < collection.models.length; ++index) {
                    if((collection.models[index][property1] === value1 || (value1 == false && typeof collection.models[index][property1] == "undefined")) 
					&& (collection.models[index][property2] === value2  || (value2 == false && typeof collection.models[index][property2] == "undefined")) && model == ''){
                        model = collection.models[index];
                    }
                }
                return model;
