define([
    ...
    'models/project'
], function (app, config, templateHelpers, _, Marionette, templ, Project) {
    'use strict';
    ...
    return Marionette.ItemView.extend({
        ...
        editDialog: function(myModel){
            ...
            app.commands.execute("app:dialog:confirm", {
				...
				'<button id="comments_edit_view" class="buttonChange buttonChangeActive">('+app.translate('Comments')+"("+this.model.get('comments_count')+")"+')</button>'+
