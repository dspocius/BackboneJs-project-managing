define([
    ...
    var projectsContr = Backbone.Model.extend({
        ...
        show: function(options){
			...
			projects.url = '/projectss/'+templates.user;
            this.id = options.id;
            if(typeof options != 'undefined' && typeof options.id != 'undefined' && options.id != '' && options.id != '_'){
                ...
                if(typeof this.projects[id] != 'undefined'){
                    ...
                    projects.url = '/projectt/'+templates.user+'/'+id;
            ...
            if(isList){
                this.onDone(id, '', isList);
            }else{
                projects.fetch().done(function(){
                    this.onDone(id,projects, isList);
                }.bind(this));
            }
        },
        onDone:function(id, projects, isList){
            var dProjects = '';
            if(!isList){
